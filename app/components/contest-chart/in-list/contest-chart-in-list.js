...
var ContestChartInListComponent = (function (_super) {
    __extends(ContestChartInListComponent, _super);
    function ContestChartInListComponent() {
        _super.apply(this, arguments);
    }
    ContestChartInListComponent = __decorate([
        core_1.Component({
